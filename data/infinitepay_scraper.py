...
class InfinitePayScraper:
    def __init__(self, base_url: str = "https://www.infinitepay.io", delay: float = 1.0):
    ...
    def scrape_website(self, start_url: str = None, max_pages: int = 50) -> List[ScrapedContent]:
...
def main():
    ...
    scraper = InfinitePayScraper(delay=1.5)  # Be respectful with delays
    
    # Start scraping
    content = scraper.scrape_website(
        start_url="https://www.infinitepay.io",
        max_pages=30  # Reasonable limit for demo
    )
